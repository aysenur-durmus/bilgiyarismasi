...
public class TarihActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        anasayfag.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(TarihActivity.this,SelectActivity.class));
                finish();
            }
        });
        ...
        //sorular
        final String[] arrayQ = {getString(R.string.t1),getString(R.string.t2),getString(R.string.t3),getString(R.string.t4),getString(R.string.t5),getString(R.string.t6),getString(R.string.t7),getString(R.string.t8),getString(R.string.t9),getString(R.string.t10)};
        final Boolean[] arrayA = {true, false, true, false, false, true, true, false, true, true};
        ...
        gec.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(dataHelper.receiveDataInt("Geç",SKIP_NUMBER)== 0 ){
                    Toast.makeText(TarihActivity.this,"0 Geçme Hakkınız Var",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    gecc--;
    ...
    private void result() {
        dataHelper.saveDataInt("PUAN TARİH", points);
        startActivity(new Intent(TarihActivity.this,TarihResultActivity.class));
        finish();
    }
}