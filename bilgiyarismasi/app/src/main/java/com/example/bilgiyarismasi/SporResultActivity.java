...
public class SporResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spor_result);
        ...
        int puan = dataHelper.receiveDataInt("PUAN SPOR" , 0);
        int eni = dataHelper.receiveDataInt("EN İYİ SPOR" , 0);
        ...
        anasay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SporResultActivity.this, SelectActivity.class);
